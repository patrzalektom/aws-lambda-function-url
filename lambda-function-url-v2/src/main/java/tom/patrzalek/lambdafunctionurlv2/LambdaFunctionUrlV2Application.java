...
public class LambdaFunctionUrlV2Application {

    private final RestTemplate awsSignedRestTemplate;

    private final AwsConfiguration awsConfiguration;

    public LambdaFunctionUrlV2Application(@Qualifier("awsSignedRestTemplate") RestTemplate awsSignedRestTemplate,
    ...
    public static void main(String[] args) {
        SpringApplication.run(LambdaFunctionUrlV2Application.class, args);
    }
